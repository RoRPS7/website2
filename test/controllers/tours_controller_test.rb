...
class ToursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tour" do
    assert_difference('Tour.count') do
      post tours_url, params: { tour: { attractions_id: @tour.attractions_id, guide_id: @tour.guide_id } }
    end
  ...
  test "should update tour" do
    patch tour_url(@tour), params: { tour: { attractions_id: @tour.attractions_id, guide_id: @tour.guide_id } }
