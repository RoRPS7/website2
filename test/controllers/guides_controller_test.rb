...
class GuidesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create guide" do
    assert_difference('Guide.count') do
      post guides_url, params: { guide: { name: @guide.name, surname: @guide.surname, telnumber: @guide.telnumber } }
    end
  ...
  test "should update guide" do
    patch guide_url(@guide), params: { guide: { name: @guide.name, surname: @guide.surname, telnumber: @guide.telnumber } }
